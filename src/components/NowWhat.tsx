...
export default () => {
  ...
  return (
    <Card className={classes.card}>
      <CardHeader title="OK, Bikale Aberra, you're all setup. Now What?" />
      <CardContent>
        <List>
          <ListItem>
            <Avatar>1</Avatar>
        ...
        <Typography variant="body1">
          Remember to refer to our <a
            href="https://react.eogresources.com/assessing"
          >
            How We Assess Submissions
          </a>
          {" "}
          guidelines, as well as the <a
            href="https://react.eogresources.com/api"
          >
